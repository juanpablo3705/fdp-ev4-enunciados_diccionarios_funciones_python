...
# funcion agregar alumnos con sus notas:
def agregar_alumno(diccionario_alumnos):
    ...
    for i in range(notas_a_ingresar):
        nota = int(input(f"Ingrese la nota numero {i + 1} de {notas_a_ingresar} de {nombre_a_agregar}: "))
...
# funcion mostrar alumnos y sus notas:
...
def ver_promedios(diccionario_alumnos):
    for cada_nombre in diccionario_alumnos:
        ...
        print(f"Alumno: {cada_nombre}. Promedio: {promedio}.")
